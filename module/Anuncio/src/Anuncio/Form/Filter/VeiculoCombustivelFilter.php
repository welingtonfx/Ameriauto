...
class VeiculoCombustivelFilter extends InputFilter
{
				 ...
				 'validators' => array(
								 array('name' => 'StringLength',
									   'options' => array(
												  		 ...
												  		 'max' => 20,
												  		 'messages' => array(
												  		 					\Zend\Validator\StringLength::TOO_SHORT	=> 'O campo Combustível deve ter no mínimo %min% caracteres.',
																  		    \Zend\Validator\StringLength::TOO_LONG 	=> 'O campo Combustível deve ter no máximo %max% caracteres.',
												  			 			    ),
									  				     ),
									  ),
				 					  ),
